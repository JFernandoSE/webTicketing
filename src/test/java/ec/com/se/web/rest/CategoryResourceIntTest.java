...
import ec.com.se.repository.CategoryRepository;
...
public class CategoryResourceIntTest {
    ...
    public void initTest() {
        ...
        category.setExternalId(DEFAULT_EXTERNAL_ID);
        category.setEnabled(DEFAULT_ENABLED);
    }
    ...
    public void createCategory() throws Exception {
        ...
        assertThat(testCategory.getExternalId()).isEqualTo(DEFAULT_EXTERNAL_ID);
    ...
    public void updateCategory() throws Exception {
        ...
        updatedCategory.setExternalId(UPDATED_EXTERNAL_ID);
        updatedCategory.setEnabled(UPDATED_ENABLED);
        ...
        assertThat(testCategory.getExternalId()).isEqualTo(UPDATED_EXTERNAL_ID);
